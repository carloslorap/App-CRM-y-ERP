...
export class ProductoService {
  ...
  crear_producto_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'crear_producto_admin', fd, {
      headers: headers,
    });
  }
  ...
  listar_producto_admin(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_producto_admin', {
      headers: headers,
    });
  }
  ...
  obtener_datos_producto_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_datos_producto_admin/' + id, {
      headers: headers,
    });
  }
  ...
  agregar_variedad_producto_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'agregar_variedad_producto_admin', data, {
      headers: headers,
    });
  }
  ...
  obtener_variedades_producto_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(
      this.url + 'obtener_variedades_producto_admin/' + id,
      {
        headers: headers,
      }
    );
  ...
  eliminar_variedad_producto_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.delete(
      this.url + 'eliminar_variedad_producto_admin/' + id,
      {
        headers: headers,
      }
    );
  ...
  listar_producto_titulo_admin(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_producto_titulo_admin', {
      headers: headers,
    });
  }
  ...
  registrar_inventario_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'registrar_inventario_admin', data, {
      headers: headers,
    });
  }
  ...
  listar_inventario_admin(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_inventario_admin', {
      headers: headers,
    });
  }
  ...
  obtener_inventario_admin(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_inventario_admin', {
      headers: headers,
    });
  }
  ...
  obtener_inventario_entrada_admin(
    ...
    return this._http.get(
      this.url + 'obtener_inventario_entrada_admin/' + year + '/' + month,
      {
        headers: headers,
      }
    );
  ...
  obtener_inventario_salida_admin(
    ...
    return this._http.get(
      this.url + 'obtener_inventario_salida_admin/' + year + '/' + month,
      {
        headers: headers,
      }
    );
