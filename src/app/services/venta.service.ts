...
export class VentaService {
  ...
  obtener_variedades_admin(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_variedades_admin', {
      headers: headers,
    });
  }
  ...
  generar_venta_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'generar_venta_admin', data, {
      headers: headers,
    });
  }
  ...
  obtener_ventas_hoy(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_ventas_hoy', {
      headers: headers,
    });
  }
