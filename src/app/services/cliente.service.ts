...
export class ClienteService {
  ...
  validar_correo_verificacion(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'validar_correo_verificacion/' + token, {
      headers: headers,
    });
  }
  ...
  listar_clientes_admin(filtro: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_clientes_admin/' + filtro, {
      headers: headers,
    });
  }
  ...
  obtener_datos_cliente_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_datos_cliente_admin/' + id, {
      headers: headers,
    });
  }
  ...
  editar_cliente_admin(id: any, data: any, token: any): Observable<any> {
    ...
    return this._http.put(this.url + 'editar_cliente_admin/' + id, data, {
      headers: headers,
    });
  }
  ...
  crear_llamada_prospeccion_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'crear_llamada_prospeccion_admin', data, {
      headers: headers,
    });
  }
  ...
  listar_llamadas_prospeccion_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(
      this.url + 'listar_llamadas_prospeccion_admin/' + id,
      { headers: headers }
    );
  }
  ...
  crear_correo_prospeccion_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'crear_correo_prospeccion_admin', data, {
      headers: headers,
    });
  }
  ...
  listar_correos_prospeccion_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_correos_prospeccion_admin/' + id, {
      headers: headers,
    });
  }
  ...
  crear_tarea_prospeccion_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'crear_tarea_prospeccion_admin', data, {
      headers: headers,
    });
  }
  ...
  listar_tareas_prospeccion_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_tareas_prospeccion_admin/' + id, {
      headers: headers,
    });
  }

  marcar_tareas_prospeccion_admin(id: any, token: any): Observable<any> {
    let headers = new HttpHeaders({
      'Content-Type': 'application/json',
      Authorization: token,
    });
    return this._http.put(
      this.url + 'marcar_tareas_prospeccion_admin/' + id,
      {},
      {
        headers: headers,
      }
  ...
  listar_actividades_prospeccion_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_actividades_prospeccion_admin/' + id, {
      headers: headers,
    });
  }
  ...
  listar_clientes_modal_admin(filtro: any,token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'listar_clientes_modal_admin/'+ filtro , {
      headers: headers,
    });
  }
  ...
  obtener_encuesta_cliente_admin(id: any, token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_encuesta_cliente_admin/' + id, {
      headers: headers,
    });
  }
