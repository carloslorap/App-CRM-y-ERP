...
export class MatriculaService {
  ...
  generar_matricula_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'generar_matricula_admin', data, {
      headers: headers,
    });
  }
  ...
  obtener_matriculas_hoy(token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_matriculas_hoy', {
      headers: headers,
    });
  }
  ...
  send_voice(
    ...
    return this._http.get(this.url +'send_voice/' + id,{headers: headers,}
    );
  }
  ...
  obtener_matricula_admin(id:any,token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_matricula_admin/'+id, {
      headers: headers,
    });
  }
  ...
  cancelar_matricula_admin(id:any,token: any): Observable<any> {
    ...
    return this._http.get(this.url + 'cancelar_matricula_admin/'+id, {
      headers: headers,
    });
  }
  ...
  obtener_comentarios_matricula_admin(id:any,token:any): Observable<any> {
    ...
    return this._http.get(this.url + 'obtener_comentarios_matricula_admin/'+id, {
      headers: headers,
    });
  }
