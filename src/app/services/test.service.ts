...
export class TestService {
  ...
  prueba_test():Observable<any>{
    ...
    return this._http.get(this.url +'prueba-test',{headers:headers})
  }
  ...
  actualizar_configuracion_general_admin( data: any, token: any): Observable<any> {
    if (data.logo != undefined) {
      ...
      return this._http.put(this.url + 'actualizar_configuracion_general_admin' , fd, {
        headers: headers,
      });
    } else {
      ...
      return this._http.put(
        this.url + 'actualizar_configuracion_general_admin' ,
        data,
        {
          headers: headers,
        }
